export function seedFatfMutualEvaluations(db) {
    console.log('  Seeding FATF mutual evaluations...');
    const insertEval = db.prepare(`INSERT INTO fatf_mutual_evaluations (country_code, country_name, evaluation_date, assessor, overall_rating, effectiveness_ratings, technical_compliance, key_findings, report_url)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)`);
    const evaluations = [
