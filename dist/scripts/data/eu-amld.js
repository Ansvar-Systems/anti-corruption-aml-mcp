export function seedEuAmld(db) {
    ...
    const insertProv = db.prepare(`INSERT INTO provisions (source_id, provision_ref, title, content, chapter, part, keywords)
     VALUES (?, ?, ?, ?, ?, ?, ?)`);
    // 4AMLD
    const amld4 = insertSource.run('Directive (EU) 2015/849 on the prevention of the use of the financial system for the purposes of money laundering or terrorist financing (4th Anti-Money Laundering Directive)', '4AMLD', 'directive', 'European Union', '2015-05-20', 'amended', 'https://eur-lex.europa.eu/eli/dir/2015/849/oj', 'Fourth Anti-Money Laundering Directive. Transposition deadline: 26 June 2017. Amended by 5AMLD (Directive 2018/843). Being replaced by the 2024 AML package.').lastInsertRowid;
    const amld4Provs = [
    ...
    // 5AMLD
    const amld5 = insertSource.run('Directive (EU) 2018/843 amending Directive 2015/849 (5th Anti-Money Laundering Directive)', '5AMLD', 'directive', 'European Union', '2018-05-30', 'amended', 'https://eur-lex.europa.eu/eli/dir/2018/843/oj', 'Fifth AML Directive amending 4AMLD. Transposition deadline: 10 January 2020. Extended scope to virtual currency exchanges and custodian wallet providers, enhanced transparency of beneficial ownership registers.').lastInsertRowid;
    const amld5Provs = [
    ...
    // 6AMLD
    const amld6 = insertSource.run('Directive (EU) 2018/1673 on combating money laundering by criminal law (6th Anti-Money Laundering Directive)', '6AMLD', 'directive', 'European Union', '2018-10-23', 'in_force', 'https://eur-lex.europa.eu/eli/dir/2018/1673/oj', 'Sixth AML Directive harmonizing the definition of money laundering criminal offences across all Member States. Transposition deadline: 3 December 2020. Establishes 22 categories of predicate offences and extends criminal liability to legal persons.').lastInsertRowid;
    const amld6Provs = [
    ...
    const amlr = insertSource.run('Regulation (EU) 2024/1624 on the prevention of the use of the financial system for the purposes of money laundering or terrorist financing (AML Regulation)', 'AMLR 2024', 'regulation', 'European Union', '2024-06-19', 'in_force', 'https://eur-lex.europa.eu/eli/reg/2024/1624/oj', 'Directly applicable AML Regulation replacing directive-based approach for most obliged entity requirements. Part of the 2024 EU AML package alongside the AMLA Regulation (EU) 2024/1620 establishing the Authority for Anti-Money Laundering. Application date: 10 July 2027.').lastInsertRowid;
    const amlrProvs = [
