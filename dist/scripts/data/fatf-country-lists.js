export function seedFatfCountryLists(db) {
    console.log('  Seeding FATF country lists...');
    const insertRating = db.prepare(`INSERT INTO fatf_country_ratings (country_code, country_name, list_status, listing_date, delisting_date, deficiencies, action_plan, last_reviewed)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?)`);
