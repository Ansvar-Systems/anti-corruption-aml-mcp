...
export function handleToolCall(db: Database.Database, name: string, args: Record<string, unknown>) {
  switch (name) {
    case 'search_aml_requirements':
      return searchAmlRequirements(db, args as any);
    case 'get_fatf_recommendation':
      return getFatfRecommendation(db, args as any);
    case 'get_fatf_country_rating':
      return getFatfCountryRating(db, args as any);
    case 'get_fatf_mutual_evaluation':
      return getFatfMutualEvaluation(db, args as any);
    case 'get_directive_article':
      return getDirectiveArticle(db, args as any);
    case 'list_sources':
    ...
    case 'assess_aml_risk':
      return assessAmlRisk(db, args as any);
    case 'map_aml_obligations':
      return mapAmlObligations(db, args as any);
    case 'get_wolfsberg_standard':
      return getWolfsbergStandard(db, args as any);
    case 'compare_aml_regimes':
      return compareAmlRegimes(db, args as any);
    default:
