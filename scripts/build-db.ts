...
const srcCount = (db.prepare('SELECT COUNT(*) as c FROM sources').get() as any).c;
const provCount = (db.prepare('SELECT COUNT(*) as c FROM provisions').get() as any).c;
const ratingCount = (db.prepare('SELECT COUNT(*) as c FROM fatf_country_ratings').get() as any).c;
const evalCount = (db.prepare('SELECT COUNT(*) as c FROM fatf_mutual_evaluations').get() as any).c;
const wolfsbergCount = (db.prepare('SELECT COUNT(*) as c FROM wolfsberg_standards').get() as any).c;
